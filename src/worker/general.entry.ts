...
// Include score.* per workflow (discovery → score → plan)
process.env.SEOA_BINDING_KEY = process.env.SEOA_BINDING_KEY || 'discovery.*,score.*,plan.*,generate.*,publish.*,metrics.*,serp.*'
