import { z } from 'zod';
export declare const PortableArticleBlockSchema: z.ZodDiscriminatedUnion<"kind", [z.ZodObject<{
...
export declare const PortableArticleDocumentSchema: z.ZodObject<{
